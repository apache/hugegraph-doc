...
or the total data size is less than TB, the [HugeGraph-Loader](/docs/quickstart/toolchain/import/hugegraph-loader) tool can be used to continuously and quickly import
graph data.
