...
> 您可以使用 `-c` 参数指定配置文件，更多 computer 配置请看：[Computer Config Options](/versions/1.5/docs/config/config-computer#computer-config-options)
...
如果没有启用 OLAP 索引，则需要启用，更多参考：[modify-graphs-read-mode](/versions/1.5/docs/clients/restful-api/graphs/#634-modify-graphs-read-mode-this-operation-requires-administrator-privileges)
...
> 更多 computer crd spec 请看：[Computer CRD](/versions/1.5/docs/config/config-computer#hugegraph-computer-crd)
>
> 更多 Computer 配置请看：[Computer Config Options](/versions/1.5/docs/config/config-computer#computer-config-options)
