...
```bash {title="download-release.sh" wrap=true collapse=2}
...
```bash {title="build-from-source.sh" wrap=true collapse=2}
...
>
> **ToplingDB (Beta)**: 作为 RocksDB 的高性能替代方案，配置方式请参考: [ToplingDB Quick Start](https://hugegraph-oink.staged.apache.org/cn/blog/2025/10/09/toplingdb-quick-start/)
