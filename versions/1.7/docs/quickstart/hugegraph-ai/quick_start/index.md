...
![RAG query scope selector](/versions/1.7/images/docs/hugegraph-ai/quick-start-03.jpg)
...
![Keywords extracted in the RAG UI](/versions/1.7/images/docs/hugegraph-ai/quick-start-04.png)
