...
在 [Quick Start](/versions/1.3/cn/docs/quickstart/hugegraph/hugegraph-server/) 部分已经介绍了使用**脚本**启停 HugeGraph-Server 的流程。下面以 Linux 平台为例，介绍使用 **IntelliJ IDEA** 运行与调试 HugeGraph-Server 的流程。
...
1. [HugeGraph-Server Quick Start](/versions/1.3/cn/docs/quickstart/hugegraph/hugegraph-server/)
