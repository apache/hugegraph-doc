...
For detailed API calls and explanations regarding permissions, please refer to the [Authentication-API](/versions/1.3/docs/clients/restful-api/auth) documentation.
