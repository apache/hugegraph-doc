...
You can use [hugegraph-tools](/versions/1.3/docs/quickstart/hugegraph-tools) to backup and restore graphs.
...
For detailed usage of backup and restore commands, please refer to the [hugegraph-tools documentation](/versions/1.3/docs/quickstart/hugegraph-tools).
