...
> [authentication](/versions/1.7/docs/config/config-authentication/), an IP allowlist, and audit logging, and isolate the Server
> process with [Docker or Kubernetes](/versions/1.7/docs/quickstart/hugegraph/hugegraph-server/#31-use-docker-container-convenient-for-testdev).
...
For authorization API usage, see the [Authentication API](/versions/1.7/docs/clients/restful-api/auth/) documentation.
