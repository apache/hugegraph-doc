...
> 注意：使用 HugeGraph-Loader 需要依赖 HugeGraph Server 服务，下载和启动 Server 请参考 [HugeGraph-Server Quick Start](/versions/1.5/cn/docs/quickstart/hugegraph/hugegraph-server)
...
> 关于 schema 的详细说明请参考 [hugegraph-client](/versions/1.5/docs/clients/hugegraph-client) 中对应部分。
...
- hugegraph 参数（参考：[hugegraph-loader 参数说明](https://hugegraph-oink.staged.apache.org/versions/1.5/cn/docs/quickstart/toolchain/hugegraph-loader/#341-%E5%8F%82%E6%95%B0%E8%AF%B4%E6%98%8E) ）
