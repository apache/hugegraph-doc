...
You can use [hugegraph-tools](/versions/1.7/docs/quickstart/toolchain/hugegraph-tools) to backup and restore the graph.
...
For detailed usage of backup and restore commands, please refer to the [hugegraph-tools documentation](/versions/1.7/docs/quickstart/toolchain/hugegraph-tools).
