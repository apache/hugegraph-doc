...
> 详细安装说明参考 [社区文档](https://hugegraph-oink.staged.apache.org/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-server/)
...
*   **HugeGraph Server 官方文档**：[https://hugegraph.apache.org/cn/docs/quickstart/hugegraph/hugegraph-server/](https://hugegraph-oink.staged.apache.org/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-server/)
