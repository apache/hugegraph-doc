...
You can use [Client-API](/versions/1.5/docs/clients/hugegraph-client) to write code to operate HugeGraph, such as adding, deleting, modifying, and querying schema and graph data, or executing gremlin statements.
...
Before running Example, you need to start the Server. For the startup process, see[HugeGraph-Server Quick Start](/versions/1.5/docs/quickstart/hugegraph/hugegraph-server).

### 4.5 More Information About Client-API

See[Introduce basic API of HugeGraph-Client](/versions/1.5/docs/clients/hugegraph-client).
