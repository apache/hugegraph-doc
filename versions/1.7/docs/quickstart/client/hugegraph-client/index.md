...
[HugeGraph Java Client](https://github.com/apache/hugegraph-toolchain/tree/master/hugegraph-client) translates Java APIs into REST requests to HugeGraph Server. It supports managing schemas and graph data, executing Gremlin queries, and calling Traverser APIs. See the [Client API](/versions/1.7/docs/clients/hugegraph-client) for detailed interfaces; this page shows how to use the client in a Java project.

For other languages, use the [Go Client](/versions/1.7/docs/quickstart/client/hugegraph-client-go) or the [Python Client](https://github.com/apache/hugegraph-ai/tree/main/hugegraph-python-client) maintained in the HugeGraph-AI repository.
...
Before running Example, you need to start the Server. For the startup process, see[HugeGraph-Server Quick Start](/versions/1.7/docs/quickstart/hugegraph/hugegraph-server).

#### 4.5 More Information About Client-API

See[Introduce basic API of HugeGraph-Client](/versions/1.7/docs/clients/hugegraph-client).
