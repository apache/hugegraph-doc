...
> To enable authentication and related configurations, please refer to the [Authentication Configuration](/versions/1.5/docs/config/config-authentication/) documentation.
