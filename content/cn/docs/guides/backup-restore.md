...
可以使用[hugegraph-tools](/cn/docs/quickstart/toolchain/export-migration/hugegraph-tools)进行图的备份和恢复。
...
备份和恢复命令的详细使用方式可以参考[hugegraph-tools文档](/cn/docs/quickstart/toolchain/export-migration/hugegraph-tools)。
