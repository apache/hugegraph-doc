...
> For detailed installation instructions, refer to [Community Documentation](https://hugegraph-oink.staged.apache.org/versions/1.7/docs/quickstart/hugegraph/hugegraph-server/)
...
<div style="text-align: center;">
    <img src="/versions/1.7/docs/images/toolchain-test-mermaid-2.png" alt="HugeGraph Toolchain Testing Process">
</div>
...
*   **HugeGraph Server Official Documentation**: [https://hugegraph.apache.org/docs/quickstart/hugegraph/hugegraph-server/](https://hugegraph-oink.staged.apache.org/versions/1.7/docs/quickstart/hugegraph/hugegraph-server/)
