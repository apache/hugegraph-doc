...
> Note: HugeGraph-Loader requires HugeGraph Server service, please refer to [HugeGraph-Server Quick Start](/versions/1.3/docs/quickstart/hugegraph/hugegraph-server) to download and start Server
...
> [!DETAILS]- click to fold/collapse hwo to install ojdbc
...
<div style="text-align: center;">
  <img src="/versions/1.3/docs/images/demo-graph-model.png" alt="image">
...
> Please refer to the corresponding section in [hugegraph-client](/versions/1.3/docs/clients/hugegraph-client) for the detailed description of the schema.
...
> [!DETAILS]- Click to expand/collapse mapping file for version 2.0
> ```json
> {
>   "version": "2.0",
>   "structs": [
...
> [!DETAILS]- Click to expand/collapse mapping file for version 1.0
> ```json
> {
>   "vertices": [
>     {
...
> [!DETAILS]- Click to expand/collapse schema file: example/file/schema.groovy
> ```groovy
> schema.propertyKey("name").asText().ifNotExist().create();
> schema.propertyKey("age").asInt().ifNotExist().create();
> schema.propertyKey("city").asText().ifNotExist().create();
...
- hugegraph parameters (Reference: [hugegraph-loader parameter description](https://hugegraph-oink.staged.apache.org/versions/1.3/docs/quickstart/toolchain/hugegraph-loader/#341-parameter-description) )
