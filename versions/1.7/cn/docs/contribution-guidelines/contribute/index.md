...
![在 GitHub 上 Fork HugeGraph 仓库](/versions/1.7/images/docs/contribution/github-fork.png)
...
![使用个人访问令牌认证 Git 推送](/versions/1.7/images/docs/contribution/github-authentication.png)
...
![在 GitHub 中验证提交邮箱](/versions/1.7/images/docs/contribution/github-email.png)
...
Contributor Agreement 使用 ASF 官方流程，见[贡献者协议](https://hugegraph-oink.staged.apache.org/versions/1.7/cn/docs/cla/)。
