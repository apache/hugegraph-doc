...
> note：${version} is the version, The latest version can refer to [Download Page](/versions/1.0/docs/download/download), Or click the link to download directly from the Download page
...
for detailed configuration introduction, please refer to [configuration document](/versions/1.0/docs/config/config-guide) and [introduction to configuration items](/versions/1.0/docs/config/config-option)
...
> for more other backend configurations, please refer to[introduction to configuration items](/versions/1.0/docs/config/config-option)
...
For detailed API, please refer to[RESTful-API](/versions/1.0/docs/clients/restful-api/)
