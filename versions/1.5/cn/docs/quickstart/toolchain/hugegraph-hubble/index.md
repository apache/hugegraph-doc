...
> 注: 数据导入功能目前适合初步试用，正式数据导入请使用 [hugegraph-loader](/versions/1.5/cn/docs/quickstart/toolchain/hugegraph-loader), 性能/稳定性/功能全面许多
...
> **注意**：目前推荐使用 [hugegraph-loader](/versions/1.5/cn/docs/quickstart/toolchain/hugegraph-loader) 进行正式数据导入，hubble 内置的导入用来做**测试**和**简单上手**
