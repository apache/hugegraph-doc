...
3. Using Java8 may loss some security ensured, we recommend using Java 11 in **production env** with [AuthSystem](/versions/1.5/docs/config/config-authentication/) enabled.
