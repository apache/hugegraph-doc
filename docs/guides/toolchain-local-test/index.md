...
> For detailed installation instructions, refer to [Community Documentation](https://hugegraph-oink.staged.apache.org/docs/quickstart/hugegraph/hugegraph-server/)
...
*   **HugeGraph Server Official Documentation**: [https://hugegraph.apache.org/docs/quickstart/hugegraph/hugegraph-server/](https://hugegraph-oink.staged.apache.org/docs/quickstart/hugegraph/hugegraph-server/)
