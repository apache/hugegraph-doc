...
> Note: HugeGraph-Loader requires HugeGraph Server service, please refer to [HugeGraph-Server Quick Start](/versions/1.5/docs/quickstart/hugegraph/hugegraph-server) to download and start Server
...
<div style="text-align: center;">
  <img src="/versions/1.5/docs/images/demo-graph-model.png" alt="image">
...
> Please refer to the corresponding section in [hugegraph-client](/versions/1.5/docs/clients/hugegraph-client) for the detailed description of the schema.
...
- hugegraph parameters (Reference: [hugegraph-loader parameter description](https://hugegraph-oink.staged.apache.org/versions/1.5/docs/quickstart/toolchain/hugegraph-loader/#341-parameter-description) )
