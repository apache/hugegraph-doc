...
or the total data size is less than TB, the [HugeGraph-Loader](/versions/1.7/docs/quickstart/toolchain/hugegraph-loader/) tool can be used to continuously and quickly import 
graph data.
