...
LLMS 索引： [llms.txt](/versions/1.3/cn/llms.txt)
...
> **注意**：目前推荐使用 [hugegraph-loader](/versions/1.3/cn/docs/quickstart/toolchain/hugegraph-loader/) 进行正式数据导入, hubble 内置的导入用来做**测试**和**简单上手**
