...
| Transaction boundaries inside a Cypher statement | One statement per request; bulk imports use the [HugeGraph Loader](/docs/quickstart/toolchain/hugegraph-loader/) |
