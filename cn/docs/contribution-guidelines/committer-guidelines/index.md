...
2. PMC 成员将通过搜索[邮件列表](https://lists.apache.org/list?dev@hugegraph.apache.org)、[issues](https://github.com/apache/hugegraph/issues)、[PRs](https://github.com/apache/hugegraph/pulls)、[官网文档](https://hugegraph-oink.staged.apache.org/docs)等方式，了解候选人如何与他人互动，以及他们所做的贡献
...
- 订阅 dev@hugegraph.apache.org，具体步骤/过滤等配置请参考[文档](https://hugegraph-oink.staged.apache.org/docs/contribution-guidelines/subscribe/)
