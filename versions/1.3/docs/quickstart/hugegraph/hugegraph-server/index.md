...
3. use `-e PASSWORD=123456` to enable auth mode and set the passoword for admin. You cna find more details from [Config Authentication](/versions/1.3/docs/config/config-authentication#Use-docker-to-enble-authentication-mode)

If you use docker desktop, you can set the option like: 
<div style="text-align: center;">
    <img src="/versions/1.3/docs/images/images-server/31docker-option.jpg" alt="image" style="width:33%;">
</div>
...
> note: `${version}` is the version, The latest version can refer to [Download Page](/versions/1.3/docs/download/download), or click the link to download directly from the Download page
...
for detailed configuration introduction, please refer to [configuration document](/versions/1.3/docs/config/config-guide) and [introduction to configuration items](/versions/1.3/docs/config/config-option)
...
If you want to use HugeGraph authentication mode, you should follow the [Server Authentication Configuration](https://hugegraph-oink.staged.apache.org/versions/1.3/docs/config/config-authentication/) configuration before you start Server later.
...
> ```
>
> > for more other backend configurations, please refer to[introduction to configuration options](/versions/1.3/docs/config/config-option)
...
For detailed API, please refer to [RESTful-API](/versions/1.3/docs/clients/restful-api)

You can also visit `localhost:8080/swagger-ui/index.html` to check the API.

<div style="text-align: center;">
  <img src="/versions/1.3/docs/images/images-server/swagger-ui.png" alt="image">
</div>
...
<div style="text-align: center;">
  <img src="/versions/1.3/docs/images/images-server/swagger-ui-where-set-auth-example.png" alt="image">
</div>

Currently, HugeGraph supports setting authentication information in two forms: Basic and Bearer.

<div style="text-align: center;">
  <img src="/versions/1.3/docs/images/images-server/swagger-ui-set-auth-example.png" alt="image">
</div>
...
Please refer to [Setup Server in IDEA](/versions/1.3/docs/contribution-guidelines/hugegraph-server-idea-setup)
