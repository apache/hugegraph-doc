...
- Subscribe to dev@hugegraph.apache.org, for specific steps/filtering configurations, please refer to the [documentation](https://hugegraph-oink.staged.apache.org/versions/1.3/docs/contribution-guidelines/subscribe/)
