...
> **注意**：使用 HugeGraph-Loader 需要依赖 HugeGraph Server 服务，下载和启动 Server 请参考 [HugeGraph-Server Quick Start](/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-server)
> 
> **测试指南**：如需在本地运行 Loader 测试，请参考 [工具链本地测试指南](/versions/1.7/cn/docs/guides/toolchain-local-test)
...
<div style="text-align: center;">
  <img src="/versions/1.7/docs/images/demo-graph-model.png" alt="由“认识”和“创建”边连接人物与软件顶点的示例图">
  <p>示例图模型</p>
</div>
...
> 关于 schema 的详细说明请参考 [hugegraph-client](/versions/1.7/docs/clients/hugegraph-client) 中对应部分。
...
- hugegraph 参数（参考：[hugegraph-loader 参数说明](https://hugegraph-oink.staged.apache.org/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-loader/#341-%E5%8F%82%E6%95%B0%E8%AF%B4%E6%98%8E) ）
