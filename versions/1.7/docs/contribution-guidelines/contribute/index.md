...
![Fork the HugeGraph repository on GitHub](/versions/1.7/images/docs/contribution/github-fork.png)
...
![Authenticate Git pushes with a personal access token](/versions/1.7/images/docs/contribution/github-authentication.png)
...
![Verify your commit email on GitHub](/versions/1.7/images/docs/contribution/github-email.png)
...
Contributor agreements follow the official ASF process. See the [Contributor Agreement](https://hugegraph-oink.staged.apache.org/versions/1.7/docs/cla/).
