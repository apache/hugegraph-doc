...
Before running Example, you need to start the Server. For the startup process, see[HugeGraph-Server Quick Start](/versions/1.0/docs/quickstart/hugegraph/hugegraph-server).

### 4.5 More Information About Example

See[Introduce basic API of HugeGraph-Client](/versions/1.0/docs/clients/hugegraph-client).
