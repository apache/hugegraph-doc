...
> Note: HugeGraph-Loader requires HugeGraph Server service, please refer to [HugeGraph-Server Quick Start](/versions/1.7/docs/quickstart/hugegraph/hugegraph-server) to download and start Server

> **Testing Guide**: For running HugeGraph-Loader tests locally, please refer to [HugeGraph Toolchain Local Testing Guide](/versions/1.7/docs/guides/toolchain-local-test)
...
<div style="text-align: center;">
  <img src="/versions/1.7/docs/images/demo-graph-model.png" alt="Example graph with person and software vertices connected by knows and created edges">
...
> Please refer to the corresponding section in [hugegraph-client](/versions/1.7/docs/clients/hugegraph-client) for the detailed description of the schema.
...
- hugegraph parameters (Reference: [hugegraph-loader parameter description](https://hugegraph-oink.staged.apache.org/versions/1.7/docs/quickstart/toolchain/hugegraph-loader/#341-parameter-description) )
