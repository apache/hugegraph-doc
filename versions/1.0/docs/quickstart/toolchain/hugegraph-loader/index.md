...
> Note: HugeGraph-Loader requires HugeGraph Server service, please refer to [HugeGraph-Server Quick Start](/versions/1.0/docs/quickstart/hugegraph/hugegraph-server) to download and start Server
...
<center>
  <img src="/versions/1.0/docs/images/oracle-download.png" alt="image">
</center>
...
<center>
  <img src="/versions/1.0/docs/images/ojdbc8.png" alt="image">
</center>
...
<center>
  <img src="/versions/1.0/docs/images/demo-graph-model.png" alt="image">
...
> Please refer to the corresponding section in [hugegraph-client](/versions/1.0/docs/clients/hugegraph-client) for the detailed description of the schema.
...
- hugegraph parameters (Reference: [hugegraph-loader parameter description](https://hugegraph-oink.staged.apache.org/versions/1.0/docs/quickstart/toolchain/hugegraph-loader/#341-parameter-description) )
