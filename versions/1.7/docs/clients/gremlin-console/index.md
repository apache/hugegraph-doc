...
Confirm that `host` and `port` match the settings in `remote.yaml`, and then follow the [steps](/versions/1.7/docs/quickstart/hugegraph/hugegraph-server) to start HugeGraph Server.
