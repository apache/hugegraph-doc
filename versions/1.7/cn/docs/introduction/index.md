...
[Apache HugeGraph](https://hugegraph-oink.staged.apache.org/) 是一套易用、高效、通用的开源**全栈图系统**（[GitHub](https://github.com/apache/hugegraph)），覆盖**图数据库**（OLTP 实时查询）、**图计算**（OLAP 大规模分析）与**图 AI**（GraphRAG / 图机器学习）三大领域。
...
- [Server 快速开始](/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-server/)
- [PD 快速开始](/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-pd/)
- [HStore 快速开始](/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-hstore/)
- [REST API](/versions/1.7/cn/docs/clients/restful-api/)
...
| 模块 | 用途 |
|---|---|
| [Client](/versions/1.7/cn/docs/quickstart/client/hugegraph-client/) | 封装 Schema 管理、图数据读写、Gremlin 和 Traverser API；支持 Java、[Python](/versions/1.7/cn/docs/quickstart/client/hugegraph-client-python/) 和 [Go](/versions/1.7/cn/docs/quickstart/client/hugegraph-client-go/)，Rust 客户端正在开发中 |
| [Loader](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-loader/) | 从本地文件、HDFS、JDBC、Kafka 或其他图读取数据，转换为顶点和边后批量导入 HugeGraph |
| [Hubble](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-hubble/) | 提供图连接、Schema、数据导入、Gremlin 查询和图形化结果展示的 Web 管理界面 |
| [Spark Connector](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-spark-connector/) | 在 Spark 作业中批量读写 HugeGraph，适合大数据离线处理 |
| [Tools](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-tools/) | 提供部署、图管理、备份恢复和 Gremlin 执行等命令行能力 |
...
- [Vermeer 快速开始](/versions/1.7/cn/docs/quickstart/computing/hugegraph-vermeer/)
- [Computer 快速开始](/versions/1.7/cn/docs/quickstart/computing/hugegraph-computer/)
...
[HugeGraph-AI 快速开始](/versions/1.7/cn/docs/quickstart/hugegraph-ai/quick_start/)
...
| 需求 | 文档 |
|---|---|
| 启动图数据库并执行查询 | [Server 快速开始](/versions/1.7/cn/docs/quickstart/hugegraph/hugegraph-server/) |
| 批量导入数据 | [Loader](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-loader/) |
| 使用 Web 界面管理图 | [Hubble](/versions/1.7/cn/docs/quickstart/toolchain/hugegraph-hubble/) |
| 运行图算法 | [Vermeer 与 Computer](/versions/1.7/cn/docs/quickstart/computing/) |
| 构建 GraphRAG 或图机器学习应用 | [HugeGraph-AI](/versions/1.7/cn/docs/quickstart/hugegraph-ai/) |

## 社区

- [GitHub Issues](https://github.com/apache/hugegraph/issues)
- 开发者邮件列表：[dev@hugegraph.apache.org](mailto:dev@hugegraph.apache.org)
- [邮件列表订阅方法](/versions/1.7/cn/docs/contribution-guidelines/subscribe/)
- 安全问题：[security@hugegraph.apache.org](mailto:security@hugegraph.apache.org)
- 微信公众号：Apache HugeGraph

![微信公众号二维码](/versions/1.7/images/docs/community/wechat.png)
{width="300" height="94"}
...
- [Introduction with HugeGraph](/versions/1.7/cn/docs/introduction/readme/)
