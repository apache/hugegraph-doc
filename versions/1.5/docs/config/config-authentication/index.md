...
For detailed API calls and explanations regarding permissions, please refer to the [Authentication-API](/versions/1.5/docs/clients/restful-api/auth) documentation.
